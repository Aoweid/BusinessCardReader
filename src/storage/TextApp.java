...
public class TextApp {
  ...
  private static final String APPLICATION_NAME = "Google-VisionTextDetection/1.0";

  /**
   * Connects to the Vision API using Application Default Credentials.
 * @param googlevisionFolder 
   */
  public static Vision getVisionService(String googlevisionFolder) throws IOException, GeneralSecurityException {
	  String filePath = googlevisionFolder+ "GoogleVisionForPennapps-f5d632f047cf.json";
    InputStream credentialStream = new FileInputStream(filePath);
	GoogleCredential credential =
    //    GoogleCredential.getApplicationDefault().createScoped(VisionScopes.all());
    		GoogleCredential.fromStream(credentialStream).createScoped(VisionScopes.all());
